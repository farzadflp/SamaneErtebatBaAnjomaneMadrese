...
public class ManagerUnverifyParentTask extends AsyncTask<MyHttpManger.RequestData, Void, String> {
    private WeakReference<ManagerVerifyParentActivity> activityReference;
    @SuppressLint("StaticFieldLeak")
    private ManagerVerifyParentActivity activity ;
    @SuppressLint("StaticFieldLeak")
    public ManagerUnverifyParentTask(ManagerVerifyParentActivity context) {
